...
* @return token string
*/
 public static String getToken(String remote_filename, int ts, String secret_key) throws UnsupportedEncodingException, NoSuchAlgorithmException, ChenxinFDFSException
 {
...
*/
 public static String genSlaveFilename(String master_filename, 
                String prefix_name, String ext_name) throws ChenxinFDFSException
 {
    ...
    {
            throw new ChenxinFDFSException("master filename \"" + master_filename + "\" is invalid");
    }
    ...
    {
        throw new ChenxinFDFSException("prefix_name \"" + prefix_name + "\" is invalid");
    }
