...
import cn.com.chenxin.common.IniFileReader;
...
*/
	public static void init(String conf_filename) throws FileNotFoundException, IOException, ChenxinFDFSException
	{
  		...
  		{
  			throw new ChenxinFDFSException("item \"tracker_server\" in " + conf_filename + " not found");
  		}
  		...
  		for (int i=0; i<szTrackerServers.length; i++)
  		{
  			...
  			if (parts.length != 2)
  			{
  				throw new ChenxinFDFSException("the value of item \"tracker_server\" is invalid, the correct format is host:port");
  			}
