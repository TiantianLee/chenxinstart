...
package cn.com.chenxin.fastdfs;
...
import cn.com.chenxin.common.Base64;
...
*/
	...
	*/
	public String[] upload_file(String local_filename, String file_ext_name, 
	       NameValuePair[] meta_list) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public String[] upload_file(String group_name, byte[] file_buff, int offset, int length,	
	       String file_ext_name, NameValuePair[] meta_list) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public String[] upload_file(String group_name, String master_filename, String prefix_name, 
         String local_filename, String file_ext_name, NameValuePair[] meta_list) throws IOException, ChenxinFDFSException
	{
		if ((group_name == null || group_name.length() == 0) || 
		    (master_filename == null || master_filename.length() == 0) ||
		    (prefix_name == null))
		{
			throw new ChenxinFDFSException("invalid arguement");
		}
	...
	*/
	public String[] upload_file(String group_name, String master_filename, String prefix_name, 
	       byte[] file_buff, String file_ext_name, NameValuePair[] meta_list) throws IOException, ChenxinFDFSException
	{
		if ((group_name == null || group_name.length() == 0) || 
		    (master_filename == null || master_filename.length() == 0) ||
		    (prefix_name == null))
	...
	*/
	public int append_file(String group_name, String appender_filename, String local_filename) throws IOException, ChenxinFDFSException
	{
		File f = new File(local_filename);
		FileInputStream fis = new FileInputStream(f);
	...
	* @return 0 for success, != 0 for error (error no)
	*/
	public int append_file(String group_name, String appender_filename, byte[] file_buff) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public int append_file(String group_name, String appender_filename, 
	       byte[] file_buff, int offset, int length) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public int append_file(String group_name, String appender_filename, 
	       long file_size, UploadCallback callback) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public int modify_file(String group_name, String appender_filename, 
			long file_offset, String local_filename) throws IOException, ChenxinFDFSException
	{
		File f = new File(local_filename);
		FileInputStream fis = new FileInputStream(f);
	...
	*/
	public int modify_file(String group_name, String appender_filename, 
			long file_offset, byte[] file_buff) throws IOException, ChenxinFDFSException
	{
		return this.do_modify_file(group_name, appender_filename, file_offset, 
	...
	*/
	public int modify_file(String group_name, String appender_filename, 
	       long file_offset, byte[] file_buff, int buffer_offset, int buffer_length) throws IOException, ChenxinFDFSException
	{
		return this.do_modify_file(group_name, appender_filename, file_offset, 
	...
	*/
	public int modify_file(String group_name, String appender_filename, 
	       long file_offset, long modify_size, UploadCallback callback) throws IOException, ChenxinFDFSException
	{
		return this.do_modify_file(group_name, appender_filename, file_offset, 
  ...
  * @param file_ext_name file ext name, do not include dot(.)
	...
	*/
           ...
           NameValuePair[] meta_list) throws IOException, ChenxinFDFSException
	{
        ...
        body_len = sizeBytes.length + ProtoCommon.FDFS_FILE_EXT_NAME_MAX_LEN + file_size;
			...
			{
				throw new ChenxinFDFSException("body length: " + pkgInfo.body.length + " <= " + ProtoCommon.FDFS_GROUP_NAME_MAX_LEN);
			}
	...
	*/
	public int delete_file(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
	...
	* @return 0 for success, none zero for fail (error code)
	*/
	public int truncate_file(String group_name, String appender_filename) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public int truncate_file(String group_name, String appender_filename, 
			long truncated_file_size) throws IOException, ChenxinFDFSException
	{
		byte[] header;
		boolean bNewConnection;
		Socket storageSocket;
	...
	*/
	public byte[] download_file(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
	...
	* @return file content/buff, return null if fail
	*/
	public byte[] download_file(String group_name, String remote_filename, long file_offset, long download_bytes) throws IOException, ChenxinFDFSException
	{
	...
	*/
	public int download_file(String group_name, String remote_filename, 
	                  String local_filename) throws IOException, ChenxinFDFSException
	{
		final long file_offset = 0;
		final long download_bytes = 0;
  ...
  * @param file_offset the start offset of the file
	...
	*/
	public int download_file(String group_name, String remote_filename, 
	                  DownloadCallback callback) throws IOException, ChenxinFDFSException
	{
		final long file_offset = 0;
		final long download_bytes = 0;
		return this.download_file(group_name, remote_filename, 
  ...
  * @param file_offset the start offset of the file
	...
	*/
	public NameValuePair[] get_metadata(String group_name, String remote_filename)throws IOException, ChenxinFDFSException
	{
		boolean bNewConnection = this.newUpdatableStorageConnection(group_name, remote_filename);
		Socket storageSocket = this.storageServer.getSocket();
	...
	*/
	public int set_metadata(String group_name, String remote_filename, 
							NameValuePair[] meta_list, byte op_flag) throws IOException, ChenxinFDFSException
	{
		boolean bNewConnection = this.newUpdatableStorageConnection(group_name, remote_filename);
		Socket storageSocket = this.storageServer.getSocket();
	...
	*/
	public FileInfo get_file_info(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
	...
	* @return FileInfo object for success, return null for fail
	*/
	public FileInfo query_file_info(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
		boolean bNewConnection = this.newUpdatableStorageConnection(group_name, remote_filename);
		Socket storageSocket = this.storageServer.getSocket();
	...
	*/
	protected boolean newWritableStorageConnection(String group_name) throws IOException, ChenxinFDFSException
	{
		...
		else
		{
  		...
  		if (this.storageServer == null)
  		{
  			throw new ChenxinFDFSException("getStoreStorage fail, errno code: " + tracker.getErrorCode());
  		}
  		return true;
		}
  }
	...
	* @return true if create a new connection
	*/
	protected boolean newReadableStorageConnection(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
		if (this.storageServer != null)
		{
			return false;
	...
	* @return true if create a new connection
	*/
	protected boolean newUpdatableStorageConnection(String group_name, String remote_filename) throws IOException, ChenxinFDFSException
	{
		if (this.storageServer != null)
		{
			return false;
