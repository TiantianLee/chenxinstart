...
public class FullInfoService {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(FullInfoService.class);
     ...
     * @param gmsfzh        身份证号
     */
    public JSONObject getFullInfoByCondition(String userCode,String xm,String sjhm,String gmsfzh){
