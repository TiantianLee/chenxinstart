 ...
 */
@Service
public class FullInfoA2Service {
    /**
     * Logger for this class
     */
    private static final Logger LOGGER = Logger.getLogger(FullInfoA2Service.class);
     ...
     * @param gmsfzh        身份证号
     */
    public JSONObject getFullInfoA2ByCondition(String userCode,String xm,String sjhm,String gmsfzh){
...
//            dataObj.put("P", PArr);
        ...
        JSONObject jo=FullInfoCserivce(userCode,xm, sjhm,gmsfzh);
        String ctate=jo.getString("resultCode");
        if(ctate.equals("0")&&state.equals("0")){
            resObj.put("resultCode", "0");
        }else{
            resObj.put("resultCode", "3"); 
        }
//        if(ctate.equals("3")){
//            JSONArray Aarray=dataObj.getJSONArray("A");
//            JSONArray Tarray=dataObj.getJSONArray("T");
//            JSONArray Garray=new JSONArray();
//            JSONArray carray=jo.getJSONArray("data");
//            for (Object object : carray) {
//                ExpTb js= (ExpTb) object;
//                String sjhmc=js.getSjhm();
//                Tarray.add(sjhmc);
//                String dhhm=js.getDhhm();
//                Garray.add(dhhm);
//                String dz=js.getSf()+js.getCs()+js.getDq()+js.getDz();
//                Aarray.add("dz");
//            }
//            
//            dataObj.put("A",Aarray);
//            dataObj.put("T",Tarray);
//            dataObj.put("G",Garray);
//        }else{
//            dataObj.put("G",new JSONArray());
//        }
        dataObj.put("C", jo.getJSONArray("data"));
     ...
     * @return
     */
    public JSONObject FullInfoCserivce(String userCode,String xm,String sjhm,String gmsfzh){
        
       JSONObject resObj= fullInfoTBService.getFullInfoC(null, userCode, xm, sjhm, null);
       JSONObject resObj2=new JSONObject();
       String resultCode = resObj.getString("resultCode");
       if ("3".equals(resultCode)) {
           resObj2.put("resultCode", "3");
           JSONArray arrObj = new JSONArray();
           arrObj.add("");
           resObj2.put("reasonCode", arrObj);
           
               JSONArray EA=resObj.getJSONArray("data");
               
             
               resObj2.put("data", EA);
            
       } else {
           resObj2.put("resultCode", "0");
           JSONArray arrObj = new JSONArray();
           arrObj.add("");
           resObj2.put("reasonCode", arrObj);
           resObj2.put("data",new JSONArray());
       }
        return resObj2;
    ...
    public static void main(String[] args) throws IOException, Exception {
        System.out.println(DES_Encrypt.decrypt("nL3rE6KKh29ka5DDQjcY8w==", "ccsp!@#$"));
